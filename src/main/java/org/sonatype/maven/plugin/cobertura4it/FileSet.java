 ...
 * @version $Id: FileSet.java 110 2009-01-03 12:08:59Z bentmann $
 */
public class FileSet
{
     ...
     */
    public Collection<File> scan( boolean files, boolean dirs )
    {
        ...
        if ( getDirectory().isDirectory() )
        {
            ...
            if ( files )
            {
                ...
                {
                    paths.add( new File( scanner.getBasedir(), path ) );
                }
            }
